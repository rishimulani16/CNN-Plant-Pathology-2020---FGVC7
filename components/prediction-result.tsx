          ...
          {isHealthy ? (
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-green-800">Leaf appears healthy!</p>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <h4 className="font-medium text-green-800 mb-2">Preventive Care Tips:</h4>
                <ul className="text-sm text-green-700 space-y-1">
                  <li>• Maintain proper spacing between trees for air circulation</li>
                  <li>• Regular pruning to remove dead or diseased branches</li>
                  <li>• Monitor for early signs of disease during growing season</li>
                </ul>
              </div>
            </div>
          ) : (
